...
//Adding the recently connected socket to the allClients list
allClients.push(socket)
console.log(`A client is connected! ${socket.id} - Number of sockets is: ${allClients.length}`)
...
socket.on('disconnect', function (reason) {
 console.log(`${socket.id} got disconnected due to ${reason}`)
